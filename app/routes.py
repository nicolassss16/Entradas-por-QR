...
from flask_wtf import FlaskForm  # <--- 1. IMPORTA ESTO
...
def index():
    ...
    form = FlaskForm()  # <--- 2. CREA UNA INSTANCIA DEL FORMULARIO
...
def register():
    ...
    # Nota: Si register.html también usa {{ form.csrf_token }}, 
    # necesitarás agregar form = FlaskForm() aquí también.
...
def login():
    ...
    # Nota: Si login.html también usa {{ form.csrf_token }}, 
    # necesitarás agregar form = FlaskForm() aquí también.
